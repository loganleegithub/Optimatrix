...
def test_short_vol_task_has_open_fact_lifecycle_closure_and_closed_live_gates() -> None:
    ...
    assert "**Current construction subgate:** `FACT_LIFECYCLE_CLOSURE`" in opening
    assert (
