...
`UNAVAILABLE`, not inferred as an effective permission fact. The observation is not a
DecisionWindow, TradeCase, Position, `ShadowRiskAllocation`, `AccountRiskReservation`, order,
trade, or Outcome. A known empty BTC
