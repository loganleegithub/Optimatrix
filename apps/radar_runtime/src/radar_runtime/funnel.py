...
_BOUNDED_BLOCKER_REASONS = frozenset(
    {
        "ATOMIC_AVAILABILITY_NOT_SETTLED",
        "ATOMIC_AVAILABILITY_UNKNOWN",
        "ATOMIC_SCOPE_NOT_EVALUABLE",
        "BASELINE_ARITHMETIC_UNKNOWN",
        "CLOSE_INDEX_UNKNOWN",
        "COMBO_CATALOG_INCOMPLETE",
        "COMBO_METADATA_UNKNOWN",
        "COMBO_QUOTE_RECEIPT_UNKNOWN",
        ...
        "OPTION_BOOK_UNKNOWN",
        "OPTION_CATALOG_INCOMPLETE",
        "OUT_OF_BASELINE_SCOPE",
        "PLATFORM_CURRENTNESS_UNKNOWN",
        "PUBLIC_ATOMIC_QUOTE_NOT_OBSERVED",
        "RADAR_EPISODE_NOT_ACTIVE",
        "RADAR_SCOPE_NOT_CURRENT",
        "RPC_REFRESH_UNKNOWN",
        "SHORT_OPTION_METADATA_UNKNOWN",
        "SHORT_TICKER_UNKNOWN",
        "TIME_BAND_BOUNDARY",
...
class FunnelTracker:
    ...
    def _observe_shadow_records(
        ...
        for value in records:
            ...
            elif kind == "CANDIDATE_ACTIVATION" and state is not None:
            ...
            elif kind == "SHADOW_ENTRY" and state is not None:
...
def _bounded_blocker_reason(value: str | None, *, fallback: str) -> str:
    if value is None:
        return fallback
    if value in _BOUNDED_BLOCKER_REASONS:
        return value
