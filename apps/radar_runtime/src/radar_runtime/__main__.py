...
from radar_runtime.observation import run_bounded_radar_candidate_observation
...
def main() -> int:
    ...
    observation_parser = subparsers.add_parser("observe-radar-candidate-validity")
    ...
    if arguments.command == "observe-radar-candidate-validity":
